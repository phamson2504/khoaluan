					      ...
					      <div class="modal-body">
					        	<c:url var="savePhong" value="/admin/luuPhong?idRap=${idRap}&idKhuVuc=${idKhuVuc}" />
					        	 ...
					        	 <div class="form-group row">
								    <label for="formGroupExampleInput" class="col-sm-3 col-form-label">Tên Phong</label>
								    <div class="col-sm-9">
								      <input name="tenPhong" type="text" class="form-control"/>
								    </div>
								  </div>
								  <div class="form-group row">
								    <label for="formGroupExampleInput" class="col-sm-3 col-form-label">Số Lượng Cột</label>
								    <div class="col-sm-9">
								      <input name="cot" type="text" class="form-control"/>
								    </div>
								  </div>
								  <div class="form-group row">
								    <label for="formGroupExampleInput" class="col-sm-3 col-form-label">Số Lượng Hàng</label>
								    <div class="col-sm-9">
